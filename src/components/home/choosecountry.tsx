...
<div className="flex justify-between gap-y-4 flex-wrap items-end">
  <div className="max-w-3xl ">
     {choosecountry?.title1 && <h4 className='text-color1 font-medium text-lg w-max'>{choosecountry?.title1}</h4>}
     <h2 className='text-zinc-800 font-extrabold text-3xl md:text-5xl !leading-[1.1]'>{choosecountry?.title2} </h2>
  </div>
