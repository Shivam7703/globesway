...
function CountDown() {
  return (
    <section className="bg-gradient-to-tr md:-mt-28 z-30 sticky from-color1 to-color2 w-[90vw] shadow-lg 
    lg:px-24 my-6 sm:mb-14 md:p-16 sm:p-12 p-7 max-w-[1350px] mx-auto text-white rounded-3xl flex flex-wrap gap-6 md:justify-between justify-center">
      {data?.map((counts: any) => (
