      ...
      >
        {data?.team?.map((cards: any) => (
          ...
          >
            ...
            <div className="px-5 py-3 text-left bg-zinc-100">
              <h5 className="text-zinc-500 font-medium md:text-lg">
                {cards?.para}
              </h5>
              <h5 className="text-black font-bold md:text-2xl font1 text-xl">
                {cards?.name}
              </h5>
            </div>
          </div>
