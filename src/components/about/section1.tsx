      ...
      >
        <div className="space-y-7 overflow-hidden hover14 relative h-full ">
          {data?.img2 && (
            <Image
              ...
              className="absolute top-0 left-0 h-[80%] w-[80%] object-cover"
            />
          )}
        </div>

        {/* <div className="absolute py-3 px-5 border-l-4 border-color1 bg-white -left-4  bottom-10 shadow-xl">
          {" "}
        ...
        {data?.img2 && (
          <Image
            ...
            src={data?.img2}
            alt="Best immigration consultants in Delhi"
            className=" absolute z-10 top-0 right-0 w-[49%] h-[100%] border-2 border-white object-cover"
          />
        )} */}
      </motion.div>
    </motion.div>
